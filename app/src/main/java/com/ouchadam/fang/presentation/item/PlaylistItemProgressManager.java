...
class PlaylistItemProgressManager extends ListItemProgress<FullItem, PlaylistAdapter.ViewHolder> {

    public PlaylistItemProgressManager(TypedBaseAdapter<FullItem> baseAdapter) {
        super(baseAdapter);
    }
