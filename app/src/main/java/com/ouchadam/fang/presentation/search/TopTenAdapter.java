...
public class TopTenAdapter extends TypedListAdapter<Entry> {

    private final LayoutInflater layoutInflater;
    private final Context context;

    public TopTenAdapter(LayoutInflater layoutInflater, Context context) {
    ...
    private void updateViewHolder(ViewHolder holder, Entry item) {
    ...
    private void setHolderText(ViewHolder holder, Entry item) {
        holder.channelTitle.setText(item.getName());
        holder.channelOwner.setText(item.getArtist());
