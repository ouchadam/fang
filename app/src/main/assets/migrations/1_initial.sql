...
CREATE TABLE IF NOT EXISTS "ITEM" ("_id" INTEGER PRIMARY KEY NOT NULL, "CHANNEL" TEXT NOT NULL, "TITLE" TEXT NOT NULL UNIQUE, "PUBDATE" LONG, "AUDIO_URL" TEXT, "AUDIO_TYPE" TEXT, "LINK" TEXT, "SUBTITLE" TEXT, "SUMMARY" TEXT);
